  ...
  return (
    <>
      <svg
        ...
        <g>
          <path
            d="M504.358,228.912c-26.078-42.437-94.703-119.8-248.426-119.8c-153.129,0-221.815,76.766-248.122,119.306
		...
		C315.35,133.959,377.973,196.582,368.483,270.925z"></path>
          <path
            d="M281.795,241.807c-6.305-1.814-11.459-6.93-13.305-13.226c-3.082-10.505,2.334-20.347,10.979-24.194
		c-7.178-3.304-15.123-5.14-23.537-5.14c-31.6,0-57.215,25.94-56.744,57.612c0.447,30.097,25.787,55.438,55.885,55.885
		c31.672,0.472,57.614-25.145,57.614-56.746c0-9.38-2.305-18.261-6.377-26.072C302.709,239.049,292.592,244.913,281.795,241.807z"></path>
        </g>
      </svg>
    </>
  )
