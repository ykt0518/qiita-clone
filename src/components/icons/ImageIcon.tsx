  ...
  return (
    <>
      <svg
		...
		C87.656,396.172,93.219,399.469,99.281,399.469z"></path>
          <path
            d="M322.672,223.906c23.688,0,42.922-19.219,42.922-42.922c0-23.688-19.234-42.906-42.922-42.906
		c-23.703,0-42.922,19.219-42.922,42.906C279.75,204.688,298.969,223.906,322.672,223.906z"></path>
          <path d="M0,19.703v472.594h512v-25.313V19.703H0z M461.375,441.672H50.625V70.328h410.75V441.672z"></path>
        </g>
      </svg>
    </>
  )
